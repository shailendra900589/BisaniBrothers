...
<section class="relative h-[80vh] min-h-[500px] flex items-center relative overflow-hidden">
    
    <div class="absolute inset-0 z-0">
        <img src="assets/bg/Staffing_Solutions.webp"
             alt="Indian professionals in corporate setting" 
...
<section class="py-24 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-aos="fade-up">
        ...
        <h2 class="text-4xl md:text-5xl font-extrabold text-[#173978] mb-8 leading-tight">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="flex flex-col items-center text-center bg-white/5 p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors h-full">
                <div class="w-16 h-16 rounded-full bg-[#2fcaf0] flex items-center justify-center text-[#173978] text-2xl font-bold mb-6 shadow-lg shadow-[#2fcaf0]/20">
...
<section class="py-20 bg-gray-50 relative" id="staffing-enquiry">
                ...
                <div class="bg-white p-8 md:p-10 rounded-3xl shadow-2xl border-t-8 border-[#2fcaf0] h-full flex flex-col justify-center">
                    ...
                    <form action="" method="POST" class="space-y-5" data-enquiry-form="1">
                        ...
                        <div>
                            ...
                            <textarea name="message" rows="3" class="w-full bg-gray-50 border border-gray-200 rounded-lg p-4 focus:outline-none focus:border-[#2fcaf0] focus:ring-1 focus:ring-[#2fcaf0] transition-colors font-medium text-gray-800 resize-none" placeholder="<?php echo page_te('form_ph_message'); ?>" required minlength="5"></textarea>
                        </div>
...
<script>
    function scrollToStaffing() {
        const section = document.getElementById('staffing-enquiry');
        if (section) {
