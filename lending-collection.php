...
enquiry_process_general_form($pdo, 'Lending & Collection Page');
...
<section class="relative h-[80vh] min-h-[600px] flex items-center relative overflow-hidden">
    
    <div class="absolute inset-0 z-0">
        <img src="assets/bg/Lending_Collection.webp"
             alt="Professionals in call center and collections environment" 
            ...
            <div class="bg-white p-8 md:p-10 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 group" data-aos="fade-up" data-aos-delay="100">
                <div class="flex items-start gap-5">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 leading-relaxed"><?php echo page_te('c1_desc'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-8 md:p-10 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 group" data-aos="fade-up" data-aos-delay="200">
                <div class="flex items-start gap-5">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 leading-relaxed"><?php echo page_te('c2_desc'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-8 md:p-10 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 group" data-aos="fade-up" data-aos-delay="300">
                <div class="flex items-start gap-5">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 leading-relaxed"><?php echo page_te('c3_desc'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-8 md:p-10 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 group" data-aos="fade-up" data-aos-delay="400">
                <div class="flex items-start gap-5">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 leading-relaxed"><?php echo page_te('c4_desc'); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-24 bg-[#173978] text-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-3xl md:text-5xl font-extrabold mb-6"><?php echo page_te('deliver_title'); ?> <span class="text-[#2fcaf0]"><?php echo page_te('deliver_highlight'); ?></span></h2>
            <p class="text-blue-100 text-lg leading-relaxed max-w-3xl mx-auto"><?php echo page_te('deliver_desc'); ?></p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" data-aos="fade-up" data-aos-delay="100">
            <div class="flex flex-col items-center text-center bg-white/5 p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors h-full">
                <div class="w-16 h-16 rounded-full bg-[#2fcaf0] flex items-center justify-center text-[#173978] text-2xl font-bold mb-6 shadow-lg shadow-[#2fcaf0]/20"><i class="fa-solid fa-piggy-bank"></i></div>
                <h3 class="text-lg font-bold leading-tight"><?php echo page_te('d1'); ?></h3>
            </div>
            <div class="flex flex-col items-center text-center bg-white/5 p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors h-full">
                <div class="w-16 h-16 rounded-full bg-[#2fcaf0] flex items-center justify-center text-[#173978] text-2xl font-bold mb-6 shadow-lg shadow-[#2fcaf0]/20"><i class="fa-solid fa-headset"></i></div>
                <h3 class="text-lg font-bold leading-tight"><?php echo page_te('d2'); ?></h3>
            </div>
            <div class="flex flex-col items-center text-center bg-white/5 p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors h-full">
                <div class="w-16 h-16 rounded-full bg-[#2fcaf0] flex items-center justify-center text-[#173978] text-2xl font-bold mb-6 shadow-lg shadow-[#2fcaf0]/20"><i class="fa-solid fa-user-shield"></i></div>
                <h3 class="text-lg font-bold leading-tight"><?php echo page_te('d3'); ?></h3>
            </div>
            <div class="flex flex-col items-center text-center bg-white/5 p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors h-full">
                <div class="w-16 h-16 rounded-full bg-[#2fcaf0] flex items-center justify-center text-[#173978] text-2xl font-bold mb-6 shadow-lg shadow-[#2fcaf0]/20"><i class="fa-solid fa-file-contract"></i></div>
                <h3 class="text-lg font-bold leading-tight"><?php echo page_te('d4'); ?></h3>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-stretch">
            ...
            <div class="flex flex-col justify-between h-full" data-aos="fade-right">
                <div>
                    ...
                    <div class="space-y-8">
                        <div class="flex items-start gap-5">
                            <div class="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center text-[#cb595c] font-bold text-2xl shrink-0 border border-gray-100"><i class="fa-solid fa-briefcase"></i></div>
                            <div><h4 class="font-bold text-[#173978] text-lg"><?php echo page_te('why_pan_industry'); ?></h4><p class="text-gray-600 text-sm mt-1 leading-relaxed"><?php echo page_te('why_pan_industry_d'); ?></p></div>
                        </div>
                        <div class="flex items-start gap-5">
                            <div class="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center text-[#cb595c] font-bold text-2xl shrink-0 border border-gray-100"><i class="fa-solid fa-rocket"></i></div>
                            <div><h4 class="font-bold text-[#173978] text-lg"><?php echo page_te('why_rapid'); ?></h4><p class="text-gray-600 text-sm mt-1 leading-relaxed"><?php echo page_te('why_rapid_d'); ?></p></div>
                        </div>
                        <div class="flex items-start gap-5">
                            <div class="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center text-[#cb595c] font-bold text-2xl shrink-0 border border-gray-100"><i class="fa-solid fa-list-check"></i></div>
                            <div><h4 class="font-bold text-[#173978] text-lg"><?php echo page_te('why_process'); ?></h4><p class="text-gray-600 text-sm mt-1 leading-relaxed"><?php echo page_te('why_process_d'); ?></p></div>
                        </div>
                        <div class="flex items-start gap-5">
                            <div class="w-14 h-14 bg-white rounded-xl shadow-sm flex items-center justify-center text-[#cb595c] font-bold text-2xl shrink-0 border border-gray-100"><i class="fa-solid fa-eye"></i></div>
                            <div><h4 class="font-bold text-[#173978] text-lg"><?php echo page_te('why_accountability'); ?></h4><p class="text-gray-600 text-sm mt-1 leading-relaxed"><?php echo page_te('why_accountability_d'); ?></p></div>
                        </div>
                    </div><br><br>
            ...
            <div data-aos="fade-left" class="h-full">
                <div class="bg-white p-8 md:p-10 rounded-3xl shadow-2xl border-t-8 border-[#2fcaf0] h-full flex flex-col justify-center">
                    ...
                    <form action="" method="POST" class="space-y-5" id="lending-form" data-enquiry-form="1">
