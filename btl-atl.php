...
enquiry_process_general_form($pdo, 'BTL & ATL Activation Page');
...
<div class="w-full overflow-hidden">
    ...
    <section class="relative h-[80vh] min-h-[500px] md:min-h-[600px] flex items-center w-full">
        
        <div class="absolute inset-0 z-0">
            <img src="assets/bg/BTL_ATL_Activities.webp"
                 alt="Brand promoters engaging with consumers" 
                 class="w-full h-full object-cover object-center">
            
            <div class="absolute inset-0 bg-black/40 sm:bg-black/10"></div>
        </div>

        <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center" data-aos="fade-up">
            
            <div class="w-full max-w-full sm:max-w-2xl md:max-w-4xl bg-[#173978]/80 sm:bg-[#173978]/50 backdrop-blur-md sm:backdrop-blur-sm p-6 sm:p-10 md:p-16 rounded-2xl sm:rounded-[2rem] shadow-2xl border border-white/10 text-left">
    ...
    <section class="py-16 md:py-24 bg-white w-full">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-aos="fade-up">
            ...
            <h2 class="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#173978] mb-6 md:mb-8 leading-tight">
                <?php echo page_te('intro_title'); ?>
            </h2>
            
            <p class="text-base sm:text-lg md:text-xl text-gray-600 text-center leading-relaxed max-w-3xl mx-auto font-medium px-2">
    ...
    <section class="py-16 md:py-24 bg-[#f4f7fc] relative w-full">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="text-center mb-12 sm:mb-16" data-aos="fade-up">
                <h2 class="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#173978]"><?php echo page_te('challenges_title'); ?></h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                ...
                <div class="bg-white p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 group" data-aos="fade-up" data-aos-delay="400">
                    <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-5 text-center sm:text-left">
                        <div class="w-14 h-14 rounded-full bg-[#fff5f5] flex-shrink-0 flex items-center justify-center text-[#cb595c] group-hover:scale-110 transition-transform">
                            <i class="fa-solid fa-chart-line-down text-2xl"></i>
                        </div>
                        <div>
    ...
    <section class="py-16 md:py-24 bg-[#173978] text-white relative w-full">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="text-center mb-12 sm:mb-16" data-aos="fade-up">
                ...
                <p class="text-blue-100 text-base sm:text-lg leading-relaxed max-w-3xl mx-auto px-2">
                    <?php echo page_te('deliver_desc'); ?>
                </p>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6" data-aos="fade-up" data-aos-delay="100">
                
                <div class="flex flex-col items-center text-center bg-white/5 p-6 sm:p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors h-full">
                    <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#2fcaf0] flex items-center justify-center text-[#173978] text-xl sm:text-2xl font-bold mb-4 sm:mb-6 shadow-lg shadow-[#2fcaf0]/20">
                        <i class="fa-solid fa-rocket"></i>
                    </div>
                    <h3 class="text-base sm:text-lg font-bold leading-tight"><?php echo page_te('d1'); ?></h3>
                </div>
                ...
                <div class="flex flex-col items-center text-center bg-white/5 p-6 sm:p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors h-full">
                    ...
                    <h3 class="text-base sm:text-lg font-bold leading-tight"><?php echo page_te('d2'); ?></h3>
                </div>
                ...
                <div class="flex flex-col items-center text-center bg-white/5 p-6 sm:p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors h-full">
                    ...
                    <h3 class="text-base sm:text-lg font-bold leading-tight"><?php echo page_te('d3'); ?></h3>
                </div>
                ...
                <div class="flex flex-col items-center text-center bg-white/5 p-6 sm:p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors h-full">
                    ...
                    <h3 class="text-base sm:text-lg font-bold leading-tight"><?php echo page_te('d4'); ?></h3>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-stretch">
                ...
                <div class="flex flex-col justify-between h-full order-2 lg:order-1" data-aos="fade-right">
                    ...
                    <div>
                        <h2 class="text-2xl sm:text-3xl font-extrabold text-[#173978] mb-8 text-center lg:text-left"><?php echo page_te('why_bbpl'); ?></h2>
                        ...
                        <div class="pt-8 sm:pt-10 text-center lg:text-left">
                    ...
                    <div class="bg-white p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl shadow-2xl border-t-8 border-[#2fcaf0] h-full flex flex-col justify-center">
                        ...
                        <form action="" method="POST" class="space-y-4 sm:space-y-5" data-enquiry-form="1">
                            ...
                            <div>
                                ...
                                <textarea name="message" rows="3" class="w-full bg-gray-50 border border-gray-200 rounded-lg p-3 sm:p-4 text-sm sm:text-base focus:outline-none focus:border-[#2fcaf0] focus:ring-1 focus:ring-[#2fcaf0] transition-colors font-medium text-gray-800 resize-none" placeholder="<?php echo page_te('form_ph_message'); ?>" required minlength="5"></textarea>
                            </div>

                            <button type="submit" class="w-full bg-[#173978] text-white font-bold text-base sm:text-lg py-3.5 sm:py-4 rounded-xl hover:bg-[#2fcaf0] hover:text-[#173978] transition-all shadow-lg hover:shadow-xl hover:-translate-y-1">
    ...
    function scrollToBTL() {
        const section = document.getElementById('btl-enquiry');
        if (section) {
