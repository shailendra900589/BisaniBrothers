...
enquiry_process_general_form($pdo, 'EV Infrastructure Support Page');
...
<div class="w-full overflow-hidden max-w-[100vw]">
    ...
    <section class="relative h-screen sm:h-[80vh] min-h-[500px] md:min-h-[600px] flex items-center w-full">
        
        <div class="absolute inset-0 z-0">
            <img src="assets/bg/ev.webp"
                 alt="EV Charging Station Infrastructure" 
                 class="w-full h-full object-cover object-center bg-slate-800">
            <div class="absolute inset-0 bg-black/50 sm:bg-black/30"></div>
        </div>

        <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center mt-10 sm:mt-0" data-aos="fade-up">
            
            <div class="w-full max-w-full sm:max-w-2xl md:max-w-4xl bg-[#173978]/80 sm:bg-[#173978]/60 backdrop-blur-md sm:backdrop-blur-sm p-6 sm:p-10 md:p-16 rounded-2xl sm:rounded-[2rem] shadow-2xl border border-white/10 text-center sm:text-left mx-2 sm:mx-0">
                ...
                <div class="bg-white p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 group" data-aos="fade-up" data-aos-delay="100">
                    <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-5 text-center sm:text-left">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 leading-relaxed text-sm sm:text-base"><?php echo page_te('c1_desc'); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 group" data-aos="fade-up" data-aos-delay="200">
                    <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-5 text-center sm:text-left">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 leading-relaxed text-sm sm:text-base"><?php echo page_te('c2_desc'); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 group" data-aos="fade-up" data-aos-delay="300">
                    <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-5 text-center sm:text-left">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 leading-relaxed text-sm sm:text-base"><?php echo page_te('c3_desc'); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-300 group" data-aos="fade-up" data-aos-delay="400">
                    <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-5 text-center sm:text-left">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 leading-relaxed text-sm sm:text-base"><?php echo page_te('c4_desc'); ?></p>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-16 sm:py-24 bg-white w-full">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" data-aos="fade-up">
            <h2 class="text-3xl md:text-4xl font-extrabold text-[#173978] mb-6"><?php echo page_te('seo_verify_title'); ?></h2>
            <p class="text-gray-600 leading-relaxed text-lg mb-4"><?php echo page_te('seo_verify_p1'); ?></p>
            <p class="text-gray-600 leading-relaxed text-lg"><?php echo page_te('seo_verify_p2'); ?></p>
        </div>
    </section>
