...
<div class="w-full overflow-hidden">
    ...
    <section class="py-16 sm:py-24 bg-white w-full">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" data-aos="fade-up">
            <h2 class="text-3xl md:text-4xl font-extrabold text-[#173978] mb-6"><?php echo page_te('seo_b2b_title'); ?></h2>
            <p class="text-gray-600 leading-relaxed text-lg mb-4"><?php echo page_te('seo_b2b_p1'); ?></p>
            <p class="text-gray-600 leading-relaxed text-lg"><?php echo page_te('seo_b2b_p2'); ?></p>
        </div>
    </section>
